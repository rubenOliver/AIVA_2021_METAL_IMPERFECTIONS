...
if __name__ == '__main__':
    ...
    image = cv2.imread('./NEU-DET/IMAGES/scratches_30.jpg', cv2.IMREAD_COLOR)
    label, bndbox = mi.recognize(image)
    print(label)
    image = cv2.imread('./NEU-DET/IMAGES/inclusion_1.jpg', cv2.IMREAD_COLOR)
    label, bndbox = mi.recognize(image)
    print(label)
    image = cv2.imread('./NEU-DET/IMAGES/scratches_1.jpg', cv2.IMREAD_COLOR)
    label, bndbox = mi.recognize(image)
    print(label)
    image = cv2.imread('./NEU-DET/IMAGES/crazing_1.jpg', cv2.IMREAD_COLOR)
    label, bndbox=mi.recognize(image)
    print(label)
